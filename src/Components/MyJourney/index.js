    ...
    return <div className="myJourney" style={{maxWidth: 1300, margin:'auto'}}>
        ...
        <div style={{display: 'flex', alignItems:'center'}}>
            ...
            <div className="myContent">
                <p>
                    Hi! <span role="img" aria-label="waving hand"> 👋 </span> I am Yuvan Selva (official name) 1996 born. I am a qualified B.Sc Visual Communication student from SRM University, Kattankulathur, Chennai passed out in the year 2016.
                    </p>
                <p>
